...
export default function About() {
  const designServices = [
    { title: "Logo & Branding", icon: "✒️" },
    { title: "Layout Buku & Majalah", icon: "📖" },
    { title: "Ilustrasi Custom", icon: "🎨" },
    { title: "Desain Promosi", icon: "✨" }
  ];

  const branches = [
    {
      id: "pusat",
      name: "Cetak Lagi Pekalongan",
      path: "/company-profile",
      address: "Jl. Kreatif Mandiri No. 123, Sidoarjo",
      phone: "CS Cetak: +62 812-3456-7890",
      icon: "🏢"
    },
    {
      id: "cabang-kreatif",
      name: "Kuli Design Studio",
      path: "/profile",
      address: "Creative Hub Blok B-4, Surabaya",
      phone: "Konsultasi: +62 812-9988-7766",
      icon: "🎨"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] pb-24">
      ...
      {/* SEKSI 1: HERO TENTANG KAMI (Lebih Clean & Minimalis) */}
      <section className="pt-24 pb-20 px-4 max-w-4xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-black tracking-tight text-[#2E3C8B] mb-6 leading-[1.15]">
          Lebih dari sekadar <br className="hidden md:block" /> tempat fotocopy.
        </h1>
      ...
      {/* SEKSI 2: SEJARAH & STATISTIK (Desain Kalem dengan Kotak Halus) */}
      ...
      {/* SEKSI 3: PARTNER (Kuli Design - Tampilan Elegan & Soft) */}
      <section className="px-4 max-w-5xl mx-auto mb-24">
        <div className="bg-[#2E3C8B] rounded-[2rem] p-10 md:p-14 text-center overflow-hidden relative">
          {/* Aksesoris background yang sangat samar (ga norak) */}
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-10">
              Ide mentahmu, dieksekusi <br className="hidden md:block"/> oleh <span className="text-[#D94841]">Kuli Design.</span>
            </h2>
      ...
      {/* SEKSI 4: LOKASI CABANG (Clean Line Art Style) */}
      <section className="px-4 max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-2xl font-bold tracking-tight text-[#2E3C8B] mb-3">Pusat Bantuan & Lokasi Studio</h2>
          ...
          {branches.map((branch) => (
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="text-2xl bg-gray-50 text-[#2E3C8B] w-14 h-14 rounded-2xl flex items-center justify-center border border-gray-100 group-hover:bg-blue-50 transition-colors">
                  {branch.icon}
                </div>
              ...
              <div className="mt-auto flex items-center justify-between border-t border-gray-100 pt-4">
                <span className="text-xs font-bold text-gray-400 group-hover:text-[#2E3C8B] transition-colors">Lihat Halaman</span>
