...
export default function Struk() {
  ...
  const formatRupiah = (angka) => {
    ...
    }).format(angka).replace("Rp", "Rp "); // Biar ada spasi setelah Rp sesuai foto
  };

  // 🔥 FUNGSI DOWNLOAD PAKAI HTML-TO-IMAGE
  const downloadStruk = async () => {
    ...
    try {
      ...
      const dataUrl = await htmlToImage.toPng(element, { 
        ...
        pixelRatio: 3 // Kualitas Super HD biar teksnya tajam kayak foto
      }); 
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] py-16 px-4 flex flex-col items-center">
      ...
      {/* ================================================== */}
      {/* AREA STRUK PEMBELIAN (YANG AKAN DI-SCREENSHOT) */}
      {/* ================================================== */}
      <div 
        ref={strukRef} 
